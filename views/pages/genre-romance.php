...
<body>
    ...
    <section class="container">
        <h4 class="tittle">Romance</h4>
        <hr class="division">
        <div class="row book">
            <div class="col-6 col-lg-2">
                <img  class="img-responsive img-thumbnail" src="../../images/Home/home-adptation-cinco.jpg" style="width:100%" alt="">
                <p  class="line-sm-1 line-md-1 line-md2-2 line-lg-2">A Cinco Passos de Você</p>
                <form action="../../views/book.php" method="get">
                    <button value="ACPDV"  id="input" name="input" type="submit" class="btn btn-outline-info color font-weight-bold btn-block">+</button>
                </form>
                <!-- no value fica as iniciais do livro-->
            </div>
            <div class="col-6 col-lg-2">
                <img  class="img-responsive img-thumbnail" src="../../images/Home/home-adptation-stars.jpg" style="width:100%" alt="">
                <p class="line-sm-1 line-md-1 line-md2-2 line-lg-1">A Culpa é das Estrelas</p>
                <form action="../../views/book.php" method="get">
                    <button value="ACEDE"  id="input" name="input" type="submit" class="btn btn-outline-info color font-weight-bold btn-block">+</button>
                </form>
                <!-- no value fica as iniciais do livro-->
                <!-- class line fica nos titulos q ficam 1 linha na tela de comp-->
            </div>
            <div class="col-6 col-lg-2">
                <img  class="img-responsive img-thumbnail" src="../../images/Home/home-popullar-hipotese.jpg" style="width:100%" alt="">
                <p class="line-sm-1 line-md-1 line-md2-2 line-lg-1">A Hipótese do Amor</p>
                <form action="../../views/book.php" method="get">
            ...
            <div class="col-6 col-lg-2">
                <img  class="img-responsive img-thumbnail" src="../../images/Home/home-popullar-gelato.jpg" style="width:100%" alt="">
                <p class="line-sm-1 line-md-1 line-md2-1 line-lg-1">Amor & Gelato</p>
                <form action="../../views/book.php" method="get">
                    <button value="AEG"  id="input" name="input" type="submit" class="btn btn-outline-info color font-weight-bold btn-block">+</button>
                </form>
                <!-- no value fica as iniciais do livro-->
            </div>
            <div class="col-6 col-lg-2">
                <img  class="img-responsive img-thumbnail" src="../../images/Home/home-autor-A.jpg" style="width:100%" alt="">
                <p class="line-sm-1 line-md-1 line-md2-1 line-lg-1">Anexos</p>
                <form action="../../views/book.php" method="get">
                    <button value="A"  id="input" name="input" type="submit" class="btn btn-outline-info color font-weight-bold btn-block">+</button>
                </form>
            </div>
            <div class="col-6 col-lg-2">
                <img  class="img-responsive img-thumbnail" src="../../images/Home/home-autor-mil.jpg" style="width:100%" alt="">
                <p class="line-sm-2 line-md-1 line-md2-2 line-lg-2">As Mil Partes do Meu Coração</p>
                <form action="../../views/book.php" method="get">
